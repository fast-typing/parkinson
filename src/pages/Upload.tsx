                ...
                {files[index] ? (
                  <>
                    <svg
                      ...
                      color="#000000"
                    >
                      <path d="M5 13L9 17L19 7" stroke="var(--success-color)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                    </svg>
                    <p>Файл загружен</p>
                  </>
                ) : (
                  <>
                    <svg
                      ...
                      color="#000000"
                    >
                      <path d="M6 20L18 20" stroke="var(--main-color)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                      <path
